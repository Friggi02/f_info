...
/*inserisce un numero nella lista rispettando un ordine crescente (affinchè l'ordine crescente sia preservato durante l'inserimenti, si assume che la lista di partenza sia ordinata in tale ordine)*/
...
/*restituisce il puntatore al primo nodo contenente il numero specificato come parametro, altrimenti NULL*/
